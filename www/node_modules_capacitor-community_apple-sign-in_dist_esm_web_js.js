(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["node_modules_capacitor-community_apple-sign-in_dist_esm_web_js"],{
...
/* harmony export */   SignInWithAppleWeb: () => (/* binding */ SignInWithAppleWeb)
/* harmony export */ });
...
/* harmony import */ var scriptjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! scriptjs */ 94144);
...
class SignInWithAppleWeb extends _capacitor_core__WEBPACK_IMPORTED_MODULE_1__.WebPlugin {
  constructor() {
    super({
    ...
    return new Promise(resolve => {
      if (!this.isAppleScriptLoaded) {
        if (typeof window !== undefined) {
          scriptjs__WEBPACK_IMPORTED_MODULE_2__.get(this.appleScriptUrl, () => resolve(true));
        } else {
          resolve(false);
        }
      } else {
...
//# sourceMappingURL=node_modules_capacitor-community_apple-sign-in_dist_esm_web_js.js.map