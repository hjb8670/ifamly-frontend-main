(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["node_modules_capacitor-community_photoviewer_dist_esm_web_js"],{

/***/ 96736:
/*!***********************************************************************!*\
  !*** ./node_modules/@capacitor-community/photoviewer/dist/esm/web.js ***!
  \***********************************************************************/
...
/* harmony export */   PhotoViewerWeb: () => (/* binding */ PhotoViewerWeb)
/* harmony export */ });
...
/* harmony import */ var jeep_photoviewer_loader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! jeep-photoviewer/loader */ 13472);



class PhotoViewerWeb extends _capacitor_core__WEBPACK_IMPORTED_MODULE_1__.WebPlugin {
  constructor() {
    super();
    this._imageList = [];
    this._options = {};
  ...
  show(options) {
    ...
    return (0,C_Users_DELL_Downloads_ifamily_client_main_ifamily_client_main_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      (0,jeep_photoviewer_loader__WEBPACK_IMPORTED_MODULE_2__.defineCustomElements)(window);
      if (Object.keys(options).includes('images')) {
        _this._imageList = options.images;
      }
      if (Object.keys(options).includes('options')) {
        _this._options = (_a = options.options) !== null && _a !== void 0 ? _a : {};
      }
      if (Object.keys(options).includes('mode')) {
        const mMode = options.mode;
        if (_this._modeList.includes(mMode)) {
          _this._mode = mMode !== null && mMode !== void 0 ? mMode : 'one';
        }
      }
      if (Object.keys(options).includes('startFrom')) {
        const mStartFrom = options.startFrom;
        _this._startFrom = mStartFrom !== null && mStartFrom !== void 0 ? mStartFrom : 0;
      }
      _this._photoViewer = document.createElement('jeep-photoviewer');
      _this._photoViewer.imageList = _this._imageList;
      _this._photoViewer.mode = _this._mode;
      if (_this._mode === 'one' || _this._mode === 'slider') {
        _this._photoViewer.startFrom = _this._startFrom;
      }
      const optionsKeys = Object.keys(_this._options);
      let divid;
      if (optionsKeys.length > 0) {
        _this._photoViewer.options = _this._options;
        if (optionsKeys.includes('divid')) {
          divid = _this._options.divid;
        } else {
      ...
      _this._container = document.querySelector(`#${divid}`);
      // check if already a photoviewer element
      if (_this._container != null) {
        const isPVEl = _this._container.querySelector('jeep-photoviewer');
        if (isPVEl != null) {
          _this._container.removeChild(isPVEl);
        }
        _this._container.appendChild(_this._photoViewer);
        yield customElements.whenDefined('jeep-photoviewer');
  ...
  saveImageFromHttpToInternal(options) {
    var _this2 = this;
    return (0,C_Users_DELL_Downloads_ifamily_client_main_ifamily_client_main_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
/***/ 34816:
/*!******************************************************************!*\
  !*** ./node_modules/jeep-photoviewer/dist/esm/index-796ed9f4.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const updateComponent = /*#__PURE__*/function () {
  var _ref = (0,C_Users_DELL_Downloads_ifamily_client_main_ifamily_client_main_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (hostRef, instance, isInitialLoad) {
    var _a;
    const elm = hostRef.$hostElement$;
...
const initializeComponent = /*#__PURE__*/function () {
  var _ref2 = (0,C_Users_DELL_Downloads_ifamily_client_main_ifamily_client_main_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (elm, hostRef, cmpMeta, hmrVersionId) {
    let Cstr;
    // initializeComponent
...
const disconnectedCallback = /*#__PURE__*/function () {
  var _ref3 = (0,C_Users_DELL_Downloads_ifamily_client_main_ifamily_client_main_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (elm) {
    if ((plt.$flags$ & 1 /* PLATFORM_FLAGS.isTmpDisconnected */) === 0) {
      const hostRef = getHostRef(elm);
      {
...
const loadModule = (cmpMeta, hostRef, hmrVersionId) => {
  ...
  return __webpack_require__(10528)(`./${bundleId}.entry.js`).then(importedModule => {
    {
...
/***/ 64376:
/*!**********************************************************!*\
  !*** ./node_modules/jeep-photoviewer/dist/esm/loader.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   setNonce: () => (/* reexport safe */ _index_796ed9f4_js__WEBPACK_IMPORTED_MODULE_0__.s)
/* harmony export */ });
/* harmony import */ var _index_796ed9f4_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index-796ed9f4.js */ 34816);


const defineCustomElements = (win, options) => {
  if (typeof window === 'undefined') return undefined;
  return (0,_index_796ed9f4_js__WEBPACK_IMPORTED_MODULE_0__.b)([["jeep-photo-buttons_6", [[1, "jeep-photoviewer", {
    "imageList": [16],
    "options": [16],
    "mode": [513, "pvmode"],
...
/***/ 3964:
/*!*******************************************************************!*\
  !*** ./node_modules/jeep-photoviewer/dist/esm/polyfills/index.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function applyPolyfills() {
  ...
  if (typeof window !== 'undefined') {
    ...
    if (!win.customElements || win.Element && (!win.Element.prototype.closest || !win.Element.prototype.matches || !win.Element.prototype.remove || !win.Element.prototype.getRootNode)) {
      promises.push(__webpack_require__.e(/*! import() | polyfills-dom */ "polyfills-dom").then(__webpack_require__.t.bind(__webpack_require__, /*! ./dom.js */ 45447, 23)));
    }
    ...
    if ('function' !== typeof Object.assign || !Object.entries || !Array.prototype.find || !Array.prototype.includes || !String.prototype.startsWith || !String.prototype.endsWith || win.NodeList && !win.NodeList.prototype.forEach || !win.fetch || !checkIfURLIsSupported() || typeof WeakMap == 'undefined') {
      promises.push(__webpack_require__.e(/*! import() | polyfills-core-js */ "polyfills-core-js").then(__webpack_require__.t.bind(__webpack_require__, /*! ./core-js.js */ 14604, 23)));
    }
  }
...
/***/ 13472:
/*!**************************************************************!*\
  !*** ./node_modules/jeep-photoviewer/loader/index.es2017.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _dist_esm_polyfills_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../dist/esm/polyfills/index.js */ 3964);
/* harmony import */ var _dist_esm_loader_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../dist/esm/loader.js */ 64376);
...
/***/ 10528:
/*!***********************************************************************************************************************************************!*\
  !*** ./node_modules/jeep-photoviewer/dist/esm/ lazy ^\.\/.*\.entry\.js$ include: \.entry\.js$ exclude: \.system\.entry\.js$ namespace object ***!
  \***********************************************************************************************************************************************/
...
//# sourceMappingURL=node_modules_capacitor-community_photoviewer_dist_esm_web_js.js.map