...
`, this.el);
    ...
    this.animateToDate = /*#__PURE__*/function () {
      var _ref = (0,_Users_mac_Desktop_My_Projects_frontend_ifamily_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (targetValue) {
        const {
          workingParts
        } = _this;
        /**
  ...
  renderTimeOverlay() {
    ...
    return [(0,_index_a1a47f01_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      ...
      disabled: disabled,
      onClick: function () {
        var _ref2 = (0,_Users_mac_Desktop_My_Projects_frontend_ifamily_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
          const {
            popoverRef
          } = _this6;
          if (popoverRef) {
