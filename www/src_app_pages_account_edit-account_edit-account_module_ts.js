ACA,6BAAA;EACA,0CAAA;EACA;wBAAA;ACNJ;;ADUA;EACI,mCAAA;EACA,eAAA;EACA,kBAAA;ACPJ;;ADUA;EACI,wBAAA;ACPJ;;ADUA;;EAEI,qBAAA;ACPJ;;ADUA;EACI,4BAAA;EACA,6BAAA;ACPJ","sourcesContent":["ion-header {\n    background-color: var(--ion-color-blanco);\n    margin-bottom: -30px;\n}\n\n.title_txt {\n    font-family: 'Sk-Modernist-Bold';\n    font-size: 18px;\n}\n\n.save-Bt {\n    font-family: 'Sk-Modernist-Bold';\n    font-size: 18px;\n    color: var(--ion-color-primary1);\n    text-transform: none;\n}\n\n.txtTitle {\n    font-family: 'Sk-Modernist-Bold';\n    font-size: 16px;\n    color: var(--ion-color-negro);\n    margin-bottom: 0;\n}\n\nion-item {\n    font-family: 'Sk-Modernist-Bold';\n    font-size: 16px;\n    --detail-icon-color: var(--ion-color-primary1);\n}\n\n.detailText {\n    font-family: 'Sk-Modernist-Regular';\n    font-size: 16px;\n    --color: var(--ion-color-gris1);\n    margin-right: 0px;\n}\n\n.item-field {\n    --background: var(--ion-color-blanco);\n    --color: var(--ion-color-negro);\n    --color-focused: var(--ion-color-negro);\n    --border-width: 1px !important;\n    --padding-top: 3px; \n    --padding-start: 0px;\n    --highlight-color-invalid: none;\n    --highlight-color-valid: none;\n    --highlight-color-focused: none !important;\n\n    &.item-shape-round {\n        border-style: solid !important;\n        border-width: 1px !important;\n        border-radius: 15px !important; \n    }\n\n}\n\n.item-field::part(native) {\n    border: none;\n}\n\n.item-highlight {\n    border-width: 0px !important;\n}\n\n.camposLabel-CItem {\n    font-family: 'Sk-Modernist-Regular';\n    font-size: 16px;\n    \n    &.label-floating {\n        font-family: 'Sk-Modernist-Regular';\n        font-size: 17px;\n        color: var(--ion-color-negro) !important;\n        max-width: fit-content !important;\n        margin-top: -6px;\n    }\n}\n\n.input-CItem {\n    font-family: 'Sk-Modernist-Regular';\n    font-size: 19px;\n    margin-top: 5px;\n}\n\n.toggleChk {\n    display: flex;\n    --background: var(--ion-color-gris1);\n    --background-checked: var(--ion-color-primary1);\n    --handle-background: var(--ion-color-blanco);\n    --handle-background-checked: var(--ion-color-blanco);\n    --handle-spacing: 2px;\n    --handle-height: 25px;\n    --handle-width: 25px;\n    width: 50px;\n    height: 30px;\n    padding: 0px;\n    padding-right: 5px;\n    border: 0.6px solid var(--ion-color-blanco);\n    border-radius: 18px;\n}\n\n.cal-Bt {\n    display: block;\n    font-family: 'Sk-Modernist-Bold';\n    font-size: 13px;\n    text-transform: none;\n    width: 100%;\n    height: 60px;\n    --border-radius: 10px;\n    --box-shadow:none;\n}\n\n.img-cal {\n    width: 25px;\n    height: 25px;\n    margin-right: 10px;\n}\n\n.date-cal {\n    margin-left: auto;\n    margin-right: 0;\n}\n\n.modal-cal {\n    --width: 400px;\n}\n\n.content-cal {\n    .scroll-content {\n        display: flex !important;\n        align-items: center !important;\n    }\n}\n\nion-datetime {\n    --background: var(--ion-color-blanco);\n    font-family: 'Sk-Modernist-Bold';\n    margin-left: auto;\n    margin-right: auto;\n    margin-top: 20px;\n}\n\n.title-cal {\n    display: block;\n    text-align: center;\n    font-family: 'Sk-Modernist-Bold';\n    font-size: 18px;\n    color: var(--ion-color-negro);\n}\n\n.calInter-Bt {\n    display: block;\n    font-family: 'Sk-Modernist-Bold';\n    font-size: 15px;\n    text-transform: none;\n    width: 100%;\n    height: 60px;\n    --border-radius: 10px;\n    --box-shadow:none;\n\n    margin-top: 10px;\n    padding-left: 30px;\n    padding-right: 30px;\n}\n\n.ion-item-long {\n    --background: var(--ion-color-blanco);\n    --color: var(--ion-color-negro);\n    --color-focused: var(--ion-color-negro);\n    --border-width: 1px !important;\n    --padding-top: 3px;\n    margin-top: 15px;\n    --highlight-color-invalid: none;\n    --highlight-color-valid: none;\n    --highlight-color-focused: none !important;\n    height: 170px;\n\n    &.item-shape-round {\n        border-style: solid !important;\n        border-width: 1px !important;\n        border-radius: 10px !important; \n    }\n}\n\n.ion-item-long::part(native) {\n    border: none;\n}\n\n.item-highlight {\n    border-width: 0px !important;\n}\n\n.ion-item-select {\n    --background: var(--ion-color-blanco);\n    --color: var(--ion-color-negro);\n    --color-focused: var(--ion-color-negro);\n    --border-width: 1px !important;\n    --border-radius: 15px;\n    --border-color: var(--ion-color-negro);\n    //--padding-bottom: 0px; \n    --padding-start: 15px;\n    --highlight-color-invalid: none;\n    --highlight-color-valid: none;\n    --highlight-color-focused: none !important;\n    /* margin-top: 30px;\n    margin-bottom: 70px; */\n}\n\nion-select {\n    font-family: 'Sk-Modernist-Regular';\n    font-size: 16px;\n    --padding-end: 0px;\n}\n\nion-select::part(icon) {\n    display: none !important;\n}\n\n.item-interactive-disabled.sc-ion-label-md-h:not(.item-multiple-inputs),\n    .item-interactive-disabled:not(.item-multiple-inputs) .sc-ion-label-md-h{\n    opacity: 1 !important;\n}\n\n.contenedorLoc{\n    margin-left: 20px !important;\n    margin-right: 20px !important;\n}","ion-header {\n  background-color: var(--ion-color-blanco);\n  margin-bottom: -30px;\n}\n\n.title_txt {\n  font-family: \"Sk-Modernist-Bold\";\n  font-size: 18px;\n}\n\n.save-Bt {\n  font-family: \"Sk-Modernist-Bold\";\n  font-size: 18px;\n  color: var(--ion-color-primary1);\n  text-transform: none;\n}\n\n.txtTitle {\n  font-family: \"Sk-Modernist-Bold\";\n  font-size: 16px;\n  color: var(--ion-color-negro);\n  margin-bottom: 0;\n}\n\nion-item {\n  font-family: \"Sk-Modernist-Bold\";\n  font-size: 16px;\n  --detail-icon-color: var(--ion-color-primary1);\n}\n\n.detailText {\n  font-family: \"Sk-Modernist-Regular\";\n  font-size: 16px;\n  --color: var(--ion-color-gris1);\n  margin-right: 0px;\n}\n\n.item-field {\n  --background: var(--ion-color-blanco);\n  --color: var(--ion-color-negro);\n  --color-focused: var(--ion-color-negro);\n  --border-width: 1px !important;\n  --padding-top: 3px;\n  --padding-start: 0px;\n  --highlight-color-invalid: none;\n  --highlight-color-valid: none;\n  --highlight-color-focused: none !important;\n}\n.item-field.item-shape-round {\n  border-style: solid !important;\n  border-width: 1px !important;\n  border-radius: 15px !important;\n}\n\n.item-field::part(native) {\n  border: none;\n}\n\n.item-highlight {\n  border-width: 0px !important;\n}\n\n.camposLabel-CItem {\n  font-family: \"Sk-Modernist-Regular\";\n  font-size: 16px;\n}\n.camposLabel-CItem.label-floating {\n  font-family: \"Sk-Modernist-Regular\";\n  font-size: 17px;\n  color: var(--ion-color-negro) !important;\n  max-width: fit-content !important;\n  margin-top: -6px;\n}\n\n.input-CItem {\n  font-family: \"Sk-Modernist-Regular\";\n  font-size: 19px;\n  margin-top: 5px;\n}\n\n.toggleChk {\n  display: flex;\n  --background: var(--ion-color-gris1);\n  --background-checked: var(--ion-color-primary1);\n  --handle-background: var(--ion-color-blanco);\n  --handle-background-checked: var(--ion-color-blanco);\n  --handle-spacing: 2px;\n  --handle-height: 25px;\n  --handle-width: 25px;\n  width: 50px;\n  height: 30px;\n  padding: 0px;\n  padding-right: 5px;\n  border: 0.6px solid var(--ion-color-blanco);\n  border-radius: 18px;\n}\n\n.cal-Bt {\n  display: block;\n  font-family: \"Sk-Modernist-Bold\";\n  font-size: 13px;\n  text-transform: none;\n  width: 100%;\n  height: 60px;\n  --border-radius: 10px;\n  --box-shadow:none;\n}\n\n.img-cal {\n  width: 25px;\n  height: 25px;\n  margin-right: 10px;\n}\n\n.date-cal {\n  margin-left: auto;\n  margin-right: 0;\n}\n\n.modal-cal {\n  --width: 400px;\n}\n\n.content-cal .scroll-content {\n  display: flex !important;\n  align-items: center !important;\n}\n\nion-datetime {\n  --background: var(--ion-color-blanco);\n  font-family: \"Sk-Modernist-Bold\";\n  margin-left: auto;\n  margin-right: auto;\n  margin-top: 20px;\n}\n\n.title-cal {\n  display: block;\n  text-align: center;\n  font-family: \"Sk-Modernist-Bold\";\n  font-size: 18px;\n  color: var(--ion-color-negro);\n}\n\n.calInter-Bt {\n  display: block;\n  font-family: \"Sk-Modernist-Bold\";\n  font-size: 15px;\n  text-transform: none;\n  width: 100%;\n  height: 60px;\n  --border-radius: 10px;\n  --box-shadow:none;\n  margin-top: 10px;\n  padding-left: 30px;\n  padding-right: 30px;\n}\n\n.ion-item-long {\n  --background: var(--ion-color-blanco);\n  --color: var(--ion-color-negro);\n  --color-focused: var(--ion-color-negro);\n  --border-width: 1px !important;\n  --padding-top: 3px;\n  margin-top: 15px;\n  --highlight-color-invalid: none;\n  --highlight-color-valid: none;\n  --highlight-color-focused: none !important;\n  height: 170px;\n}\n.ion-item-long.item-shape-round {\n  border-style: solid !important;\n  border-width: 1px !important;\n  border-radius: 10px !important;\n}\n\n.ion-item-long::part(native) {\n  border: none;\n}\n\n.item-highlight {\n  border-width: 0px !important;\n}\n\n.ion-item-select {\n  --background: var(--ion-color-blanco);\n  --color: var(--ion-color-negro);\n  --color-focused: var(--ion-color-negro);\n  --border-width: 1px !important;\n  --border-radius: 15px;\n  --border-color: var(--ion-color-negro);\n  --padding-start: 15px;\n  --highlight-color-invalid: none;\n  --highlight-color-valid: none;\n  --highlight-color-focused: none !important;\n  /* margin-top: 30px;\n  margin-bottom: 70px; */\n}\n\nion-select {\n  font-family: \"Sk-Modernist-Regular\";\n  font-size: 16px;\n  --padding-end: 0px;\n}\n\nion-select::part(icon) {\n  display: none !important;\n}\n\n.item-interactive-disabled.sc-ion-label-md-h:not(.item-multiple-inputs),\n.item-interactive-disabled:not(.item-multiple-inputs) .sc-ion-label-md-h {\n  opacity: 1 !important;\n}\n\n.contenedorLoc {\n  margin-left: 20px !important;\n  margin-right: 20px !important;\n}"],"sourceRoot":""}]);
// Exports
