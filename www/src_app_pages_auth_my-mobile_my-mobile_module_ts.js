...
.flag-icon-ow {
  margin-right: 5px;
}`, "",{"version":3,"sources":["webpack://./src/app/components/codes-phone-head/codes-phone-head.component.scss"],"names":[],"mappings":"AAAA;EACI,gCAAA;EACA,eAAA;AACJ;;AAEA;EACI,gCAAA;EACA,eAAA;AACJ;;AAEA;EACI,mCAAA;EACA,eAAA;AACJ;;AAEA;EACI,mCAAA;EACA,eAAA;AACJ;;AAEA;EACI,iBAAA;AACJ","sourcesContent":[".title-header {\n    font-family: 'Sk-Modernist-Bold';\n    font-size: 20px;\n}\n\n.btn-cancel {\n    font-family: 'Sk-Modernist-Bold';\n    font-size: 15px;\n}\n\n.search-bar {\n    font-family: 'Sk-Modernist-Regular';\n    font-size: 14px;\n}\n\nion-item {\n    font-family: 'Sk-Modernist-Regular';\n    font-size: 15px;\n}\n\n.flag-icon-ow {\n    margin-right: 5px;\n}"],"sourceRoot":""}]);
// Exports
...
.next-Bt {
  ...
  --box-shadow:none;
  margin-top: 30px;
}`, "",{"version":3,"sources":["webpack://./src/app/pages/auth/my-mobile/my-mobile.page.scss"],"names":[],"mappings":"AAAA;EACI,mBAAA;EACA,iBAAA;EACA,mBAAA;EACA,gBAAA;AACJ;;AAEA;EACI,gCAAA;EACA,eAAA;EACA,gBAAA;EACA,oBAAA;AACJ;;AAEA;EACI,cAAA;EACA,mCAAA;EACA,eAAA;EACA,eAAA;EACA,mBAAA;AACJ;;AAEA;EACI,qBAAA;EACA,mBAAA;EACA,sCAAA;EACA,qBAAA;EACA,+BAAA;EACA,6BAAA;EACA,0CAAA;EACA,kBAAA;AACJ;;AAEA;EAEI,mCAAA;EACA,eAAA;EACD;uBAAA;AACH;;AAGA;EACI,mCAAA;EACA,eAAA;EACA,yBAAA;EACA,aAAA;EACA,mBAAA;EACA,kBAAA;EACA,gBAAA;AAAJ;;AAGA;EACI,0BAAA;EACA,iBAAA;EACA,iBAAA;AAAJ;;AAGA;EACI,cAAA;EACA,gCAAA;EACA,eAAA;EACA,oBAAA;EACA,WAAA;EACA,YAAA;EACA,qBAAA;EACA,iBAAA;EACA,gBAAA;AAAJ","sourcesContent":["ion-back-button {\n    border-style: solid;\n    border-width: 1px;\n    border-radius: 15px;\n    margin-top: 20px;\n}\n\n.title-h1 {\n    font-family: 'Sk-Modernist-Bold';\n    font-size: 30px;\n    margin-top: 40px;\n    margin-bottom: -10px;\n}\n\n.text-p {\n    display: block;\n    font-family: 'Sk-Modernist-Regular';\n    font-size: 14px;\n    margin-top: 0px;\n    margin-bottom: 40px;\n}\n\nion-item {\n    --border-style: solid;\n    --border-width: 1px;\n    --border-color: var(--ion-color-negro);\n    --border-radius: 15px;\n    --highlight-color-invalid: none;\n    --highlight-color-valid: none;\n    --highlight-color-focused: none !important;\n    --min-height: 60px;\n}\n\nion-intl-tel-input {\n    //background: red;\n    font-family: 'Sk-Modernist-Regular';\n    font-size: 16px;\n   /*  height: 70px;\n    margin-top: -30px; */\n}\n\n.item-code {\n    font-family: 'Sk-Modernist-Regular';\n    font-size: 16px;\n    color: #4d4d4d !important;\n    margin-top: 0;\n    --padding-bottom: 0;\n    --padding-start: 0;\n    --padding-end: 0;\n}\n\n.flag-icon-my {\n    font-size: 16px !important;\n    margin-right: 5px;\n    margin-left: 15px;\n}\n\n.next-Bt {\n    display: block;\n    font-family: 'Sk-Modernist-Bold';\n    font-size: 15px;\n    text-transform: none;\n    width: 100%;\n    height: 40px;\n    --border-radius: 10px;\n    --box-shadow:none;\n    margin-top: 30px;\n}"],"sourceRoot":""}]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___.toString();
