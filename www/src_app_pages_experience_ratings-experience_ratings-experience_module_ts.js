...
.comment-rate {
  ...
  font-size: 14px;
  color: var(--ion-color-gris1);
}`, "",{"version":3,"sources":["webpack://./src/app/pages/experience/ratings-experience/ratings-experience.page.scss","webpack://./../../My%20Projects/frontend-ifamily/src/app/pages/experience/ratings-experience/ratings-experience.page.scss"],"names":[],"mappings":"AAAA;EACI,eAAA;EACA,mBAAA;EACA,YAAA;EACA,WAAA;EACA,6BAAA;EACA,iBAAA;EACA,mBAAA;EACA,gBAAA;EACA,gBAAA;ACCJ;;ADEA;EACI,6BAAA;ACCJ;;ADEA;EACI,YAAA;EACA,aAAA;EACA,cAAA;ACCJ;;ADEA;EACI,sDAAA;ACCJ;;ADEA;EACI,gCAAA;EACA,eAAA;EACA,6BAAA;EACA,SAAA;ACCJ;;ADEA;EACI,kBAAA;EACA,YAAA;EACA,YAAA;EACA,gBAAA;EACA,iBAAA;EACA,kBAAA;ACCJ;;ADGA;EACI,kBAAA;EACA,eAAA;EACA,gCAAA;ACAJ;;ADGA;EACI,kBAAA;EACA,eAAA;EACA,6BAAA;ACAJ;;ADGA;EACI,kBAAA;EACA,gCAAA;EACA,eAAA;EACA,6BAAA;EACA,gDAAA;EACA,SAAA;EACA,iBAAA;ACAJ;;ADGA;EACI,kBAAA;EACA,eAAA;EACA,kBAAA;ACAJ;;ADGA;EACI,kBAAA;EACA,WAAA;ACAJ;;ADGA;EACI,gCAAA;EACA,eAAA;EACA,6BAAA;ACAJ","sourcesContent":[".btnBack {\n    font-size: 18px;\n    border-style: solid;\n    height: 48px;\n    width: 50px;\n    color: var(--ion-color-negro);\n    border-width: 1px;\n    border-radius: 15px;\n    margin-top: 20px;\n    margin-left: 0px;\n}\n\nion-icon {\n    color: var(--ion-color-negro);\n}\n\nion-avatar { \n    width: 100px;  \n    height: 100px;\n    margin: 0 auto;\n}\n\n.img-avatar {\n    border: 2px solid var(--ion-color-primary1) !important;\n}\n\n.txtName {\n    font-family: 'Sk-Modernist-Bold';\n    font-size: 24px;\n    color: var(--ion-color-negro);\n    margin: 0;\n}\n\n.content-starts {\n    position: relative;\n    width: 250px;\n    height: 50px;\n    margin-top: 17px;\n    margin-left: auto;\n    margin-right: auto;\n    //margin-bottom: 20px;\n}\n\n.rate-start {\n    position: absolute;\n    font-size: 40px;\n    color: var(--ion-color-primary1);\n}\n\n.rate-start-gris {\n    position: absolute;\n    font-size: 40px;\n    color: var(--ion-color-gris1);\n}\n\n.date-rate {\n    position: absolute;\n    font-family: 'Sk-Modernist-Bold';\n    font-size: 16px;\n    color: var(--ion-color-negro);\n    border-left: 4px solid var(--ion-color-primary1);\n    margin: 0;\n    padding-left: 5px;\n}\n\n.div-start-lt {\n    position: relative;\n    margin-top: 4px;\n    margin-left: 105px;\n}\n\n.rate-start-lt {\n    position: absolute;\n    width: 12px;\n}\n\n.comment-rate {\n    font-family: 'Sk-Modernist-Bold';\n    font-size: 14px;\n    color: var(--ion-color-gris1);\n}",".btnBack {\n  font-size: 18px;\n  border-style: solid;\n  height: 48px;\n  width: 50px;\n  color: var(--ion-color-negro);\n  border-width: 1px;\n  border-radius: 15px;\n  margin-top: 20px;\n  margin-left: 0px;\n}\n\nion-icon {\n  color: var(--ion-color-negro);\n}\n\nion-avatar {\n  width: 100px;\n  height: 100px;\n  margin: 0 auto;\n}\n\n.img-avatar {\n  border: 2px solid var(--ion-color-primary1) !important;\n}\n\n.txtName {\n  font-family: \"Sk-Modernist-Bold\";\n  font-size: 24px;\n  color: var(--ion-color-negro);\n  margin: 0;\n}\n\n.content-starts {\n  position: relative;\n  width: 250px;\n  height: 50px;\n  margin-top: 17px;\n  margin-left: auto;\n  margin-right: auto;\n}\n\n.rate-start {\n  position: absolute;\n  font-size: 40px;\n  color: var(--ion-color-primary1);\n}\n\n.rate-start-gris {\n  position: absolute;\n  font-size: 40px;\n  color: var(--ion-color-gris1);\n}\n\n.date-rate {\n  position: absolute;\n  font-family: \"Sk-Modernist-Bold\";\n  font-size: 16px;\n  color: var(--ion-color-negro);\n  border-left: 4px solid var(--ion-color-primary1);\n  margin: 0;\n  padding-left: 5px;\n}\n\n.div-start-lt {\n  position: relative;\n  margin-top: 4px;\n  margin-left: 105px;\n}\n\n.rate-start-lt {\n  position: absolute;\n  width: 12px;\n}\n\n.comment-rate {\n  font-family: \"Sk-Modernist-Bold\";\n  font-size: 14px;\n  color: var(--ion-color-gris1);\n}"],"sourceRoot":""}]);
// Exports
