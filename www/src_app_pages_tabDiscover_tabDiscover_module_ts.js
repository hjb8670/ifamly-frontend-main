...
/* harmony import */ var _services_discover_state_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../services/discover-state.service */ 36508);
...
let TabDiscoverPage = class TabDiscoverPage {
  constructor(formBuilder, alertController, popoverCtrl, translate, userService, uiService, matchService, gestureCtrl, zone, plt, cdRef, activatedRoute, router, discoverState) {
  ...
  setStatusDiscover(idDiscover, accionId) {
    ...
    return (0,_Users_mac_Desktop_My_Projects_frontend_ifamily_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (_this5.discoverUsrs.length > 0) {
        _this5.antDiscoverUsrs = {
          ..._this5.discoverUsrs[_this5.posCardGlobal]
        };
      }
      _this5.discoverUsrs.pop();
      _this5.posCardGlobal--;
      // Save state after change
      _this5.discoverState.setCardList(_this5.discoverUsrs);
      _this5.discoverState.setLastCardIndex(_this5.posCardGlobal);
  ...
  returnDicover() {
    ...
    return (0,_Users_mac_Desktop_My_Projects_frontend_ifamily_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (yield _this7.matchService.rollbackLike(_this7.idAntDiscover.toString())) {
        ...
        if (_this7.antDiscoverUsrs) {
          _this7.discoverUsrs.push(_this7.antDiscoverUsrs);
          ...
          _this7.antDiscoverUsrs = null; // Clear the stored user
        }
      } else {
        _this7.uiService.hideLoader();
  ...
  static {
    this.ctorParameters = () => [{
      ...
      type: _services_discover_state_service__WEBPACK_IMPORTED_MODULE_8__.DiscoverStateService
    }];
  }
  static {
    this.propDecorators = {
