...
let TabDiscoverPage = class TabDiscoverPage {
  ...
  iniFilter() {
    var _this4 = this;
    return (0,_Users_mac_Desktop_My_Projects_frontend_ifamily_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this4.user = yield _this4.userService.getUser('');
      _this4.filter = {
        selfRole: _this4.user.iam_a,
        targetRole: _this4.user.iam_looking,
        ageIni: 18,
        ageEnd: 100,
        distance: null,
        minHeight: 1,
        maxHeight: 100,
        exercise: Number(_this4.user.exercise),
        zodiacSign: Number(_this4.user.sings),
        education: Number(_this4.user.education),
        drinking: Number(_this4.user.drinking),
        smoking: Number(_this4.user.smoking),
        kids: Number(_this4.user.kids),
        religion: Number(_this4.user.religion),
        /* location: {
          country: null,
          state: null,
          address: null,
  ...
  loadDiscover() {
    ...
    return (0,_Users_mac_Desktop_My_Projects_frontend_ifamily_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      try {
        ...
        const discoverUsr_res = yield _this5.matchService.getDiscoverProfiles(_this5.iniDiscover.toString(), _this5.deltaDiscover.toString(), _this5.filter);
        //this.iniDiscover += this.deltaDiscover;
        _this5.cdRef.detectChanges();
        if (discoverUsr_res === null) {
          _this5.discoverUsrs = null;
          yield _this5.uiService.hideLoader();
          _this5.noDiscoverFound = true;
          return;
        }
        // this.setAvatarImg(discoverUsr_res);
        console.log('LOAD DISCOVER_USR: ', discoverUsr_res);
        //this.discoverUsrs.push(...discoverUsr_res);
        _this5.discoverUsrs = [...discoverUsr_res, ..._this5.discoverUsrs];
        _this5.cdRef.detectChanges();
        // Espera a que las tarjetas se rendericen y actualiza los gestos
        setTimeout(() => {
          const cardArray = _this5.cards.toArray();
          _this5.useSwipe(cardArray);
        }, 100);
        _this5.posCardGlobal = _this5.discoverUsrs.length - 1;
        if (_this5.discoverUsrs.length <= 0) {
          _this5.noDiscoverFound = true;
        } else {
          _this5.noDiscoverFound = false;
        }
      } catch (error) {
  ...
  setStatusDiscover(idDiscover, accionId) {
    ...
    return (0,_Users_mac_Desktop_My_Projects_frontend_ifamily_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      let res = yield _this6.matchService.doMatchProfiles(idDiscover.toString(), accionId.toString(), resLike, resSuperLike, null);
      ...
      if (_this6.discoverUsrs.length > 0) {
        _this6.antDiscoverUsrs = {
          ..._this6.discoverUsrs[_this6.posCardGlobal]
        };
      }
      _this6.discoverUsrs.pop();
      _this6.posCardGlobal--;
      if (_this6.discoverUsrs.length <= 1) {
        yield _this6.loadDiscover();
      }
      _this6.idAntDiscover = idDiscover;
    })();
  }
  reLoadDiscover() {
    var _this7 = this;
    return (0,_Users_mac_Desktop_My_Projects_frontend_ifamily_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this7.iniDiscover = 0;
      _this7.discoverUsrs = [];
      _this7.noDiscoverFound = true;
      _this7.cdRef.detectChanges();
      try {
        _this7.isLoading = true;
        _this7.discoverUsrs = yield _this7.matchService.getDiscoverProfiles(_this7.iniDiscover.toString(), _this7.deltaDiscover.toString(), _this7.filter);
        _this7.cdRef.detectChanges();
        yield _this7.setAvatarImg(_this7.discoverUsrs);
        if (_this7.discoverUsrs === null) {
          yield _this7.uiService.hideLoader();
          _this7.noDiscoverFound = true;
          return;
        }
        console.log('RE-LOAD DISCOVER_USR: ', _this7.discoverUsrs);
        _this7.iniDiscover = _this7.discoverUsrs.length;
        _this7.posCardGlobal = _this7.discoverUsrs.length - 1;
        if (_this7.discoverUsrs.length <= 0) {
          _this7.noDiscoverFound = true;
        } else {
          _this7.noDiscoverFound = false;
        }
        // Espera a que las tarjetas se rendericen y actualiza los gestos
        setTimeout(() => {
          const cardArray = _this7.cards.toArray();
          _this7.useSwipe(cardArray);
        }, 100);
      } catch (error) {
  ...
  returnDicover() {
    var _this8 = this;
    return (0,_Users_mac_Desktop_My_Projects_frontend_ifamily_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this8.idAntDiscover === 0) {
        _this8.uiService.alertOK(_this8.translate.instant('DISCOVER.notRollback'));
        return;
      }
      _this8.uiService.showLoader();
      if (yield _this8.matchService.rollbackLike(_this8.idAntDiscover.toString())) {
        _this8.uiService.hideLoader();
        // this.uiService.alertOK(this.translate.instant('DISCOVER.rollbackTrue'));
        _this8.idAntDiscover = 0;
        // Instead of reloading all profiles, just add the previous user back to the stack
        if (_this8.antDiscoverUsrs) {
          _this8.discoverUsrs.push(_this8.antDiscoverUsrs);
          _this8.posCardGlobal++;
          // Re-enable gestures for the new card
          setTimeout(() => {
            const cardArray = _this8.cards.toArray();
            _this8.useSwipe(cardArray);
          }, 100);
          _this8.antDiscoverUsrs = null; // Clear the stored user
        }
      } else {
        _this8.uiService.hideLoader();
        _this8.uiService.alertOK(_this8.translate.instant('DISCOVER.rollbackFalse'));
      }
    })();
  }
  doDislike() {
    var _this9 = this;
    return (0,_Users_mac_Desktop_My_Projects_frontend_ifamily_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      console.log('DIS-LIKE', _this9.posCardGlobal);
      _this9.disLikeBtn = true;
      _this9.uiService.showLoader();
      yield _this9.setStatusDiscover(_this9.discoverUsrs[_this9.posCardGlobal].personId, _this9.statusUsrDicover.dislike);
      _this9.disLikeBtn = false;
  ...
  doLike() {
    ...
    return (0,_Users_mac_Desktop_My_Projects_frontend_ifamily_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      console.log('LIKE', _this10.posCardGlobal);
      _this10.likeBtn = true;
      yield _this10.setStatusDiscover(_this10.discoverUsrs[_this10.posCardGlobal].personId, _this10.statusUsrDicover.like);
      _this10.likeBtn = false;
  ...
  doSuperLike() {
    ...
    return (0,_Users_mac_Desktop_My_Projects_frontend_ifamily_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const alert = yield _this11.alertController.create({
        ...
        header: '*',
        subHeader: _this11.translate.instant('DISCOVER.superLikeTitle'),
        message: _this11.translate.instant('DISCOVER.superLikeMsg'),
        //mode: 'md',
        //buttons: [this.translate.instant('ALERT.btnMsg')]
        buttons: [{
          text: _this11.translate.instant('DISCOVER.superLikeBtnOK'),
          role: 'OK',
          cssClass: 'alert-button-confirm'
        }, {
          text: _this11.translate.instant('DISCOVER.superLikeBtnCancel'),
          role: 'CANCEL',
  ...
  applyFilter() {
    ...
    return (0,_Users_mac_Desktop_My_Projects_frontend_ifamily_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this12.filter = {
        selfRole: _this12.iam_a.value == '' ? null : _this12.iam_a.value,
        targetRole: _this12.iam_looking.value == '' ? null : _this12.iam_looking.value,
        ageIni: _this12.age_between.value.lower,
        ageEnd: _this12.age_between.value.upper,
        distance: _this12.distance.value == '' ? null : Number(_this12.distance.value),
        minHeight: _this12.height.value.lower,
        maxHeight: _this12.height.value.upper,
        exercise: _this12.exercise.value == '' ? null : Number(_this12.exercise.value),
        zodiacSign: _this12.sing.value == '' ? null : Number(_this12.sing.value),
        education: _this12.education.value == '' ? null : Number(_this12.education.value),
        drinking: _this12.drink.value == '' ? null : Number(_this12.drink.value),
        smoking: _this12.smok.value == '' ? null : Number(_this12.smok.value),
        kids: _this12.kid.value == '' ? null : Number(_this12.kid.value),
        religion: _this12.religion.value == '' ? null : Number(_this12.religion.value),
        /* location: {
          country: null,
          state: null,
          address: null,
      ...
      console.log('FILTER: ', _this12.filter);
      yield _this12.modal.dismiss();
      yield _this12.reLoadDiscover();
    })();
  }
  onWillPresent() {
    this.noDiscoverFound = false;
  ...
  openMenuPopoverBlock(ev, personId) {
    ...
    return (0,_Users_mac_Desktop_My_Projects_frontend_ifamily_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ev.stopPropagation();
      const popover = yield _this13.popoverCtrl.create({
