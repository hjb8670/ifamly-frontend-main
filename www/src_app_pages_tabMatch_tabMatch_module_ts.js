...
.btn-card {
  ...
  padding: 0;
  --border-radius: 0;
}`, "",{"version":3,"sources":["webpack://./src/app/pages/tabMatch/tabMatch.page.scss","webpack://./../../My%20Projects/frontend-ifamily/src/app/pages/tabMatch/tabMatch.page.scss"],"names":[],"mappings":"AAAA;EACI,mCAAA;EACA,mBAAA;ACCJ;;ADEA;EACI,mBAAA;EACA,iBAAA;EACA,mBAAA;ACCJ;;ADEA;EACI,gCAAA;EACA,eAAA;EACA,iBAAA;EACA,gBAAA;ACCJ;;ADEA;EACI,mCAAA;EACA,eAAA;EACA,6BAAA;EACA,UAAA;EACA,aAAA;EACA,gBAAA;ACCJ;;ADEA;EACI,mBAAA;EACA,iBAAA;EACA,mBAAA;EACA,WAAA;EACA,YAAA;ACCJ;;ADGA;EACI,eAAA;EACA,iBAAA;EACA,kBAAA;ACAJ;;ADGA;EACI,WAAA;EACA,WAAA;EACA,kCAAA;EACA,gBAAA;ACAJ;;ADGA;EACI,cAAA;EACA,gCAAA;EACA,eAAA;EACA,kBAAA;EACA,6BAAA;EACA,yCAAA;EACA,WAAA;EACA,iBAAA;EACA,iBAAA;EACA,kBAAA;ACAJ;;ADKA;EACI,YAAA;EACA,kBAAA;ACFJ;ADII;EACI,kBAAA;ACFR;;ADMA;EACI,YAAA;EACA,iBAAA;ACHJ;ADKI;EACI,kBAAA;ACHR;;ADOA;EACI,mBAAA;EAEA,aAAA;ACLJ;;ADQA;EACI,kBAAA;EACA,WAAA;EAEA,aAAA;EACA,MAAA;EACA,OAAA;EACA,kBAAA;EACA,qBAAA;ACNJ;;ADSA;EAMI,kBAAA;EACA,WAAA;EACA,YAAA;EACA,iBAAA;EACA,oBAAA;EACA,uCAAA;EACA,wCAAA;ACXJ;;ADcA;EACI,kBAAA;EACA,gCAAA;EACA,eAAA;EACA,8BAAA;EACA,YAAA;EACA,UAAA;EAEA,gBAAA;EACA,YAAA;EACA,kBAAA;EACA,YAAA;ACZJ;;ADeA;EACI,UAAA;EACA,SAAA;ACZJ;;ADeA;EACI,cAAA;EACA,YAAA;EACA,gBAAA;EACA,cAAA;EACA,eAAA;EACA,oBAAA;EACA,UAAA;EACA,kBAAA;ACZJ","sourcesContent":[".hdPage {\n    background: var(--ion-color-blanco);\n    padding-bottom: 0px;\n}\n\nion-back-button {\n    border-style: solid;\n    border-width: 1px;\n    border-radius: 15px;\n}\n\n.titlePage {\n    font-family: 'Sk-Modernist-Bold';\n    font-size: 24px;\n    margin-top: -10px;\n    margin-bottom: 0;\n}\n\n.titleLoc {\n    font-family: 'Sk-Modernist-Regular';\n    font-size: 16px;\n    color: var(--ion-color-gris1);\n    width: 80%;\n    margin-top: 0;\n    margin-bottom: 0;\n}\n\n.menuBtn {\n    border-style: solid;\n    border-width: 1px;\n    border-radius: 10px;\n    width: 50px;\n    height: 50px;\n    //margin-top: -24px;\n}\n\n.menuIcon {\n    font-size: 28px;\n    margin-left: auto;\n    margin-right: auto;\n}\n\nhr {\n    height: 1px;\n    width: 100%;\n    background: var(--ion-color-gris1);\n    margin-top: 20px;\n}\n\n.titleSec {\n    display: block;\n    font-family: 'Sk-Modernist-Bold';\n    font-size: 14px;\n    text-align: center;\n    color: var(--ion-color-gris1);\n    background-color: var(--ion-color-blanco);\n    width: 70px;\n    margin-top: -18px;\n    margin-left: auto;\n    margin-right: auto;\n}\n\n\n\n.colD {\n    padding: 0px;\n    margin-right: -5px;\n\n    .ios {\n        margin-bottom: 0px;\n    }\n}\n\n.colI {\n    padding: 0px;\n    margin-left: -5px;\n\n    .ios {\n        margin-bottom: 0px;\n    }\n}\n\n.cardBig {\n    border-radius: 10px;\n    // height: 240px;\n    height: 185px;\n}\n\n.parent {\n    position: relative;\n    width: 100%;\n    // height: 200px;\n    height: 150px;\n    top: 0;\n    left: 0;\n    text-align: center;\n    align-content: center;\n}\n\n.imgListBig {\n    // object-fit: cover;\n    // top: 0;\n    // left: 0;\n    // max-width: 100%;\n    // max-height: 100%;\n    position: relative;\n    width: 100%;\n    height: 100%;\n    object-fit: cover;\n    object-position: top;\n    border-top-left-radius: 10px !important;\n    border-top-right-radius: 10px !important;\n}\n\n.name-p {\n    position: absolute;\n    font-family: 'Sk-Modernist-Bold';\n    font-size: 18px;\n    color: var(--ion-color-blanco);\n    bottom: 30px;\n    left: 10px;\n\n    background: gray;\n    padding: 2px;\n    border-radius: 6px;\n    opacity: 0.8;\n}\n\n.col-btn {\n    padding: 0;\n    margin: 0;\n}\n\n.btn-card {\n    display: block;\n    height: 41px;\n    margin-top: -4px;\n    margin-left: 0;\n    margin-right: 0;\n    margin-bottom: -20px;\n    padding: 0;\n    --border-radius: 0;\n}",".hdPage {\n  background: var(--ion-color-blanco);\n  padding-bottom: 0px;\n}\n\nion-back-button {\n  border-style: solid;\n  border-width: 1px;\n  border-radius: 15px;\n}\n\n.titlePage {\n  font-family: \"Sk-Modernist-Bold\";\n  font-size: 24px;\n  margin-top: -10px;\n  margin-bottom: 0;\n}\n\n.titleLoc {\n  font-family: \"Sk-Modernist-Regular\";\n  font-size: 16px;\n  color: var(--ion-color-gris1);\n  width: 80%;\n  margin-top: 0;\n  margin-bottom: 0;\n}\n\n.menuBtn {\n  border-style: solid;\n  border-width: 1px;\n  border-radius: 10px;\n  width: 50px;\n  height: 50px;\n}\n\n.menuIcon {\n  font-size: 28px;\n  margin-left: auto;\n  margin-right: auto;\n}\n\nhr {\n  height: 1px;\n  width: 100%;\n  background: var(--ion-color-gris1);\n  margin-top: 20px;\n}\n\n.titleSec {\n  display: block;\n  font-family: \"Sk-Modernist-Bold\";\n  font-size: 14px;\n  text-align: center;\n  color: var(--ion-color-gris1);\n  background-color: var(--ion-color-blanco);\n  width: 70px;\n  margin-top: -18px;\n  margin-left: auto;\n  margin-right: auto;\n}\n\n.colD {\n  padding: 0px;\n  margin-right: -5px;\n}\n.colD .ios {\n  margin-bottom: 0px;\n}\n\n.colI {\n  padding: 0px;\n  margin-left: -5px;\n}\n.colI .ios {\n  margin-bottom: 0px;\n}\n\n.cardBig {\n  border-radius: 10px;\n  height: 185px;\n}\n\n.parent {\n  position: relative;\n  width: 100%;\n  height: 150px;\n  top: 0;\n  left: 0;\n  text-align: center;\n  align-content: center;\n}\n\n.imgListBig {\n  position: relative;\n  width: 100%;\n  height: 100%;\n  object-fit: cover;\n  object-position: top;\n  border-top-left-radius: 10px !important;\n  border-top-right-radius: 10px !important;\n}\n\n.name-p {\n  position: absolute;\n  font-family: \"Sk-Modernist-Bold\";\n  font-size: 18px;\n  color: var(--ion-color-blanco);\n  bottom: 30px;\n  left: 10px;\n  background: gray;\n  padding: 2px;\n  border-radius: 6px;\n  opacity: 0.8;\n}\n\n.col-btn {\n  padding: 0;\n  margin: 0;\n}\n\n.btn-card {\n  display: block;\n  height: 41px;\n  margin-top: -4px;\n  margin-left: 0;\n  margin-right: 0;\n  margin-bottom: -20px;\n  padding: 0;\n  --border-radius: 0;\n}"],"sourceRoot":""}]);
// Exports
